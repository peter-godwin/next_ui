...
//                             {/* Other Menu Items */}
//                             {["My order", "My address", "Change password", "Log out"].map((item, index) => (
//                                 <div
//                                     key={index}
//                                     className="w-[243px] h-[45px] bg-white text-black rounded-[4px] flex items-center justify-between px-4 cursor-pointer hover:bg-gray-100"
//                                 >
//                                     <span className="font-[500] text-[14px]">{item}</span>
...
//                                     name="gender"
//                                     value="male"
//                                     className="appearance-none w-[19.5px] h-[19.5px] rounded-full border border-gray-300 checked:bg-[url('/assets/Vector.svg')] checked:bg-center checked:bg-no-repeat checked:bg-contain"
//                                 />
//                                 <span className="text-[16px] text-[#111827] font-[Poppins] font-[600]">Male</span>
//                             </label>
...
//                                     className="appearance-none w-[19.5px] h-[19.5px] rounded-full border border-gray-300 checked:bg-[url('/assets/Vector.svg')] checked:bg-center checked:bg-no-repeat checked:bg-contain"
//                                 />
//                                 <span className="text-[16px] text-[#111827] font-[Poppins] font-[600]">Female</span>
//                             </label>
//                             <hr className="w-full border-[#E5E7EB]" />
//                         </div>
//                     </div>
